...
class SignUpServiceTest {
    ...
    void signUpWithEmailTest_whenEmailAlreadyRegistered_ReturnNull() {
        ...
        Executable executable =
                () -> signUpService.signUpWithEmail(signUpRequest);

        // Then
        assertThrows(EmailAlreadyRegisteredException.class, executable);
    }
    ...
    void signUpWithEmailTest_whenInvalidSignUps_thenThrowIllegalArgumentException(SignUpRequest signUpRequest) {
        // When
        Executable executable =
                () -> signUpService.signUpWithEmail(signUpRequest);
